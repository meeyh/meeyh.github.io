import{l as E,d as Z,aT as ze,v as $e,r as B,b as Se,a7 as Be,e as p,n as b,aH as Te,aq as ee,f as Pe,s as x,t as l,q as A,aS as ke,y as oe,u as Re,i as He,g as R,x as Ie,bu as Ee,ae as Oe,B as r,bv as H,z as De,bw as Fe,aU as Ne,aR as je}from"./index-d5026f7b.js";import{i as _e,b as Ke}from"./usePageCommand-01d77dc6.js";import{i as Me}from"./language-38dd8b1f.js";import{c as J}from"./Tag-4b4c44c9.js";import{r as X,i as Ge}from"./format-length-46fade60.js";import{c as qe}from"./call-7e0089d6.js";const Ve=E("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),We=Z({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){ze("-base-wave",Ve,$e(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Se(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Be(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=Te;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 align-items: center;
 justify-content: center;
 `,[ke({top:"50%",originalTransform:"translateY(-50%)"})]),Qe()]),l("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
